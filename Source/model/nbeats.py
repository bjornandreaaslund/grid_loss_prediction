...
model_144_grid =  NBeatsNet.load('nbeats_grid1_144_G.h5')
model_288_grid =  NBeatsNet.load('nbeats_grid1_288_G.h5')
model_432_grid =  NBeatsNet.load('nbeats_grid1_432_G.h5')
model_576_grid =  NBeatsNet.load('nbeats_grid1_576_G.h5')
...
np.savetxt("y_pred_grid1_nbeats.csv", y_pred, delimiter=",")
